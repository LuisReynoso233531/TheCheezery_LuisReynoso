...
class ProductosActivity : AppCompatActivity() {
    ...
    val sweets = ArrayList<Product>()
    val salties = ArrayList<Product>()
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun agregaProductos() {
            ...
            coldDrinks.add(Product("Matcha Latte", R.drawable.matcha, "Leafy taste of matcha green tea powder with creamy milk and a little sugar for a flavor balance that will delight.", 7.0))
